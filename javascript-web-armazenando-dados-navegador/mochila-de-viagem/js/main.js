...
form.addEventListener("submit", (evento) =>{ //evento recebe os dados
    ...
    const existe = itens.find(elemento => elemento.nome === nome.value) // verifica se existe elemento com o mesmo nome
...
function deletaElemento(tag, id) { // preciso passar o ID para excluir
    tag.remove()
